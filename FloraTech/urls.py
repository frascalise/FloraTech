...
#* API *#
from .views import setup, sensor_working, sensor_warning, check_sensor, new_sensor, add_garden, show_all, delete_all, add_moisture, get_temperature, get_water,Alert
...
urlpatterns = [
    ...
    path('alert/<str:problema>/<str:username>/',Alert,name='Alert'),
    ...
    path("api/get_daily_water/", get_daily_water_needs, name="get_daily_water"),
